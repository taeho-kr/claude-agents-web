...
| 상황 | 생성 여부 | 조건 |
|------|-----------|------|
| 에이전트 2개 이상 실행 | ✅ | 태스크 그래프 관리 필요 |
| 단일 에이전트 실행 | ❌ | 워크플로우 불필요 |
...
## 태스크 그래프
| # | 에이전트 | 작업 | 의존성 | 상태 | task_id | commit |
|---|----------|------|--------|------|---------|--------|
| 1 | researcher | 코드 분석 | - | ✅ 완료 | abc123 | a1b2c3 |
| 2 | analyst | 요구사항 | - | ✅ 완료 | def456 | d4e5f6 |
| 3 | planner | 작업 계획 | 1,2 | 🔄 실행중 | ghi789 | - |
| 4 | frontend | UI 구현 | 3 | ⏳ 대기 | - | - |
| 5 | backend | API 구현 | 3 | ⏳ 대기 | - | - |
| 6 | unit-tester | 테스트 | 4,5 | ⏳ 대기 | - | - |
...
| 에이전트 | Commit | 복원 명령 |
|----------|--------|-----------|
| researcher | a1b2c3 | git restore --source a1b2c3 |
| analyst | d4e5f6 | git restore --source d4e5f6 |
```
